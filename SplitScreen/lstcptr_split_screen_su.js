 ...
 *
 * Version:         1.0.2   -   17-July-2025 - Grok Assisted - Fixed transactionTypeField undefined error
 *
...
function (serverWidget, record, file, url, search, runtime, constants) {
    ...
    function onRequest(context) {
        ...
        try {
            ...
            log.debug({ 
                ...
                details: `Length: ${formHtml.length}, Contains ${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}: ${formHtml.includes(`\${${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}}`)}, First 500 chars: ${formHtml.substring(0, 500)}` 
            });
        } catch (fileError) {
            ...
            <body>
                    ...
                    <div class="container">
                        ...
                        <div class="right-panel" id="right-panel">
                            ...
                            <div class="form-field">
                                <input type="hidden" id="${constants.CUSTOM_FIELDS.RECORD_ID}" name="${constants.CUSTOM_FIELDS.RECORD_ID}" value="${recordId}">
                            </div>
                            <div class="form-field">
                                <label>Transaction Type</label>
                                <select id="${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}" name="${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}">${transactionTypeOptionsList}</select>
                            </div>
                            <div class="form-field">
                                <label>Subsidiary</label>
                                <select id="${constants.CUSTOM_FIELDS.SUBSIDIARY}" name="${constants.CUSTOM_FIELDS.SUBSIDIARY}">${subsidiaryOptions}</select>
                            </div>
                            <div class="form-field">
                                <label>Vendor</label>
                                <select id="${constants.CUSTOM_FIELDS.VENDOR}" name="${constants.CUSTOM_FIELDS.VENDOR}">${vendorOptions}</select>
                            </div>
                            <div class="form-field" style="display:none;">
                                <label>Amount</label>
                                <input type="number" id="${constants.CUSTOM_FIELDS.AMOUNT}" name="${constants.CUSTOM_FIELDS.AMOUNT}" value="${amount}" step="0.01" min="0">
                            </div>
                            <div class="form-field" style="display:none;">
                                <label>Document Origin</label>
                                <select id="${constants.CUSTOM_FIELDS.DOCUMENT_ORIGIN}" name="${constants.CUSTOM_FIELDS.DOCUMENT_ORIGIN}">
                            ...
                            <div class="form-field">
                                <label>Memo</label>
                                <textarea id="${constants.CUSTOM_FIELDS.MEMO}" name="${constants.CUSTOM_FIELDS.MEMO}">${memo || ''}</textarea>
                            </div>
                ...
                <script>
                    function submitForm() {
                        ...
                        const fields = [
                            { id: "${constants.CUSTOM_FIELDS.RECORD_ID}", name: "Record ID" },
                            { id: "${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}", name: "Transaction Type" },
                            { id: "${constants.CUSTOM_FIELDS.SUBSIDIARY}", name: "Subsidiary" },
                            { id: "${constants.CUSTOM_FIELDS.VENDOR}", name: "Vendor" },
                            { id: "${constants.CUSTOM_FIELDS.AMOUNT}", name: "Amount" },
                            { id: "${constants.CUSTOM_FIELDS.MEMO}", name: "Memo" }
                        ];
            ...
            `;
            log.debug({ title: `${strDebugTitle} - Using Fallback HTML`, details: `Length: ${formHtml.length}, Contains ${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}: ${formHtml.includes(`\${${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}}`)}` });
        }
        ...
        const replacements = {
            ...
            [`\${${constants.CUSTOM_FIELDS.RECORD_ID}}`]: constants.CUSTOM_FIELDS.RECORD_ID,
            [`\${${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}}`]: constants.CUSTOM_FIELDS.TRANSACTION_TYPE,
            [`\${${constants.CUSTOM_FIELDS.SUBSIDIARY}}`]: constants.CUSTOM_FIELDS.SUBSIDIARY,
            [`\${${constants.CUSTOM_FIELDS.VENDOR}}`]: constants.CUSTOM_FIELDS.VENDOR,
            [`\${${constants.CUSTOM_FIELDS.AMOUNT}}`]: constants.CUSTOM_FIELDS.AMOUNT,
            [`\${${constants.CUSTOM_FIELDS.MEMO}}`]: constants.CUSTOM_FIELDS.MEMO,
            [`\${${constants.CUSTOM_FIELDS.DOCUMENT_ORIGIN}}`]: constants.CUSTOM_FIELDS.DOCUMENT_ORIGIN,
            [`\${${constants.DOCUMENT_ORIGIN.NANONET}}`]: constants.DOCUMENT_ORIGIN.NANONET
        };
        ...
        if (formHtml.includes(`\${${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}}`)) {
            log.error({ title: `${strDebugTitle} - Placeholder Error`, details: `Placeholder \${${constants.CUSTOM_FIELDS.TRANSACTION_TYPE}} not replaced` });
    ...
    function saveTransaction(data, recordId) {
        ...
        vendorBillRecord.setValue({ fieldId: constants.VENDOR_BILL_STAGING_FIELDS.TRAN_AMOUNT_INC_TAX, value: data.amount });
