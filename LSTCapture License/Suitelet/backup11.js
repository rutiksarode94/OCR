            ...
            try 
            {
                ...
                {   
                    ...
                    var productVersion = form.addField({
                        id: 'custpage_lstcptr_bundle_version',
                        type: serverWidget.FieldType.TEXT,
                    ...
                    productVersion.defaultValue = licenseData.bundleVersion || '';
        ...
        function fetchLicenseData() 
        {
            ...
            try
            {
                ...
                if (searchResult) {
                    ...
                    licenseData.bundleVersion = searchResult.getValue('custrecord_lstcptr_product_version');
