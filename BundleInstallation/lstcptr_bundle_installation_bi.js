 ...
 *
 * Name:            LSTCapture Bundle Installation(lstcptr_bundle_installation_bi.js)
 *
 * Version:         1.1.0   -   04-Dec-2024  -   RS.     -   Initial development.
 *
 * Author:          LiveStrong Technologies.
 *
 * Purpose:         This script is used to install the LSTCapture Bundle in the client account.
 *
 * Script:          customscript_lstcptr_bundle_installation_bi
 * Deploy:          customdeploy_lstcptr_bundle_installation_bi
 *
 * Notes:
 *
 * Dependencies:
 ...
 * @NModuleScope Public
 * @FileName lstcptr_bundle_installation_bi.js
 */
define(['N/file', 'N/https', 'N/format', 'N/config', 'N/search', 'N/record', 'N/runtime', 'N/encode'],
    ...
    function (file, https, format, config, search, record, runtime, encode) {
        var strDebugTitle = 'lstcptr_bundle_installation_bi';
        ...
        function afterInstall(context) {
            try {
                ...
                var ownerSuiteletUrl = `https://${curreentAccountId}.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=customscript_lstcptr_authorization_sl&deploy=customdeploy_lstcptr_authorization_sl&compid=${curreentAccountId}&ns-at=AAEJ7tMQf6yPqobneTyMtS56JWglr5-RKrj3uUXYE-Go_qHdIPQ`;
